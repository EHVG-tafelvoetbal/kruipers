const data = {
    ...
    2026: {
        ...
        02: {
            ...
            Jelmer: 5, // 04-02 (& Jasper) door Sander+Lars; // 04-02 (& Stefan) door Jasper+Lars; // 05-02 (& Ibrahim) door Beau+Reno; // 25-02 (& Sander) door Lars+Jasper;  // 26-02 (& Mike) door Beau en Jelmer;  // 26-02 (& Stefan) door Beau en Mike;
            Stefan: 6, // 04-02 (& Jelmer) door Jasper+Lars; // 09-02 (& Jasper) door Ricardo en Lars; // 16-02 (& Marijn) door Beau en Jasper; // 18-02 (& Ibrahim) door Lars & Ricardo;  // 26-02 (& Jelmer) door Beau en Mike;
